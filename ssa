...
spawn(function()
	...
	function library:Evil()
		...
		Logo.Image = "rbxassetid://17136155196"
		...
		Logo_Background.Image = "rbxassetid://17136155196"
	...
	function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("stacktop") then
				makefolder("stacktop")
			end
			if not isfolder("stacktop/bloxfruits/") then
				makefolder("stacktop/bloxfruits/")
			end
			if not isfile("stacktop/bloxfruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("stacktop/bloxfruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("stacktop/bloxfruits/" .. game.Players.LocalPlayer.Name .. ".json"))
	...
	function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("stacktop/bloxfruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("stacktop/bloxfruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
function GetMaterial(matname)
	...
	CredtSection:AddLabel({
		Name = "Copyright © 2024 Stack.top - Project. All Rights Reserved."
	})
				...
				pcall(function()
					if W1 or W2  or W3 then
						if game:GetService("Lighting").FantasySky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
							Stats_Moon:Set("Status Moon : 5/5 🌝")
						elseif game:GetService("Lighting").FantasySky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
							Stats_Moon:Set("Status Moon : 4/5 🌖")
						elseif game:GetService("Lighting").FantasySky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
							Stats_Moon:Set("Status Moon : 3/5 🌗")
						...
						elseif game:GetService("Lighting").FantasySky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" then
							Stats_Moon:Set("Status Moon : 2/5 🌘")
						elseif game:GetService("Lighting").FantasySky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" then
							Stats_MoonFM:Set("Status Moon : 1/5 🌙")
						elseif game:GetService("Lighting").FantasySky.MoonTextureId=="http://www.roblox.com/asset/?id=9709139597" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709139597" then
							...
							Stats_Moon:Set("Status Moon : 0/5 🌑")
						end
					else
		...
		spawn(function()
			while wait() do
				if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Mirage Island") then
					Mirage_Island_Stats:Set("Status Mirage Island : Found 🟢")
				else
					Mirage_Island_Stats:Set("Status Mirage Island : Not Found 🔴")
				end
			end
		end)
			...
			pcall(function()
				while task.wait() do
					if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
						Kitsunecheck:Set('Status Mirage Island : Found 🟢') 
					else
						Kitsunecheck:Set('Status Mirage Island : Not Found 🔴')
					end
				end
			end)
		end)
	...
	if W1 then
	MainSection:AddToggle({
		Name = "Auto Farm [ Level - Fast Mode ]",
		Flag = "Auto_Farm_Fast",
			...
			if _G.AutoMirageIsland or _G.Mirage then
				if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
					...
					if _G.Mode == "English" then
						game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Stack Hub",Text = "Mirage not Found!",Icon = "rbxassetid://17136155196",Duration = 1})
					else
						game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Stack Hub",Text = "เกาะลับยังไม่เกิด",Icon = "rbxassetid://17136155196",Duration = 1})
					end
				end
			end
		end
